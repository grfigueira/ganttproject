 ...
 */
public class UserStoryLoadGraphicArea extends ChartComponentBase implements ResourceChart {
    ...
    public UserStoryLoadGraphicArea(GanttProject app, ZoomManager zoomManager, ResourceTreeUIFacade treeUi) {
