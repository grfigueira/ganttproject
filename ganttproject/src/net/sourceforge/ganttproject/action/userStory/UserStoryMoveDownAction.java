...
public class UserStoryMoveDownAction extends GPAction implements TreeSelectionListener {
    private final UserStoryTreeTable myTable;

    public UserStoryMoveDownAction(UserStoryTreeTable table) {
        super("userStory.move.down");
        myTable = table;
        setEnabled(false);
    ...
    public GPAction asToolbarAction() {
        final UserStoryMoveDownAction result  = new UserStoryMoveDownAction(myTable);
