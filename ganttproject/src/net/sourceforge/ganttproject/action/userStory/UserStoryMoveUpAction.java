...
public class UserStoryMoveUpAction extends GPAction implements TreeSelectionListener {
    private final UserStoryTreeTable myTable;

    public UserStoryMoveUpAction(UserStoryTreeTable table) {
        super("userStory.move.up");
        myTable = table;
        setEnabled(false);
    ...
    public GPAction asToolbarAction() {
        final UserStoryMoveUpAction result = new UserStoryMoveUpAction(myTable);
